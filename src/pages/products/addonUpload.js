              ...
              addOns.map((a) => (
                <tr key={a._id} className="border-b">
                  <td className="px-4 py-2">
                    <img src={a.image} alt={a.name} className="w-16 h-16 object-cover rounded" />
                  </td>
                  ...
                  <td className="px-4 py-2">{a.addOn ? "Yes" : "No"}</td>
                  <td className="px-4 py-2 space-x-2">
                    ...
                    <button
                      ...
                      disabled={loading}
                      className={`px-2 py-1 rounded ${loading ? "bg-red-300" : "bg-red-500 hover:bg-red-600 text-white"}`}
                    >
                      Delete
                    </button>
                  </td>
